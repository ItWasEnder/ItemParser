...
package tv.ender.itemparser.persistent;
...
public final class PersistentDataSerializer {
    ...
    /**
     * Serializes a {@link PersistentDataContainer} MapList to JSON
     *
     * @param mapList PersistentDataContainer MapList representation
     * @return JSON string
     */
    @Contract(value = "_ -> new", pure = true)
    @NotNull
    public static JsonElement toJson(
            @NotNull final List<Map<?, ?>> mapList
    ) {
        Objects.requireNonNull(mapList, "mapList cannot be null");
        return GSON.toJsonTree(mapList, LIST_MAP_TYPE_TOKEN.getType());
    }
